 ...
 * @author RemoteUser
 */
public class VFacturaSuccess extends javax.swing.JFrame {

    /**
     * Creates new form VFacturaSuccess
     */
    public VFacturaSuccess() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Compra Finalizada con Éxito");
        ...
        jLabel10.setText("Distribuidor RUT");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VFacturaSuccess.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VFacturaSuccess().setVisible(true);
            }
        });
    }
